...
namespace HandsOnEFCodeFirst.Entities
{
    public class UworldDBContext:DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer(@"Server=tcp:myserver26.database.windows.net,1433;Initial Catalog=Moviedb;Persist Security Info=False;User ID=myadmin;Password=Admin123;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;");
            const string secretName = "sqlconn";
            var kvUri = $"https://mykey26.vault.azure.net/";
